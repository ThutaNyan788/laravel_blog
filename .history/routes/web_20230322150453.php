...
Route::get("/admin/createPage",[AdminBlogController::class,"index"])->name("admin#blogs#createPage")->middleware("admin");
...
Route::post("/admin/blogs/{blog:slug}/editPage",[AdminBlogController::class,"edit"])->name("admin#blogs#editPage");
