...
Route::middleware("admin")->prefix("/admin")->group(function(){
    ...
    Route::post("blogs",[AdminBlogController::class,"store"])->name("admin#store");
    Route::delete("blogs/{blog:slug}/delete",[AdminBlogController::class,'destroy'])->name("admin#blogs#delete");
    Route::get("blogs/{blog:slug}/editPage",[AdminBlogController::class,"edit"])->name("admin#blogs#editPage");
    Route::post("blogs/{blog:slug}/updatePage",[AdminBlogController::class,"update"])->name("admin#blogs#update");
});
