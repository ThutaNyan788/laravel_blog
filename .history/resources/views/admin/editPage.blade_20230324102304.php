            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <form class='form' action="/admin/blogs" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="container">
                            <img src="/storage/my_photo/j2SODwbnyDnB5EKI1qyvQdpHP0zly75NHWjYzbbh.png" class="img-thumbnail" alt="{{ $blog->name }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text"  name="body" cols="10" rows="10" class="form-control" id="body" placeholder="Enter Body">
                                {{ $blog->body }}
                            </textarea>
