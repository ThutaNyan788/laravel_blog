        ...
        <div class="text-center">
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <form class='form' action="/admin/blogs" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="slug" class="form-label">Photo</label>
                            <input type="text" name="photo" class="form-control" id="slug" placeholder="Enter Slug">
