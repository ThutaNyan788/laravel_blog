            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <form class='form' action="{{ route("admin#blogs#update",$blog->slug)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <x-input name='slug' title="Slug" type="text" value="{{ $blog->title }}"/>

                        <x-input name="photo" title="Photo" type="file" value="{{ $blog->title }}"/>

                        <x-input name="intro" title="Intro" type="text" value="{{ $blog->title }}"/>
